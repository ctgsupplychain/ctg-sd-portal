    ...
    <div className="max-w-2xl mx-auto px-6 py-10">
      ...
      <div className="flex items-center gap-3 mb-6">
        <button
          ...
          className="inline-flex items-center gap-1.5 text-xs text-gray-500 px-2.5 py-1.5 border border-gray-200 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors"
        >
          <ArrowLeft size={13} /> Back to Master SKU
        </button>
        <div className="w-px h-4 bg-gray-200" />
        <h1 className="text-sm font-semibold text-gray-900">Update / Upload SKUs</h1>
      </div>
      ...
      {result && (
        <div className="mt-4 space-y-3">
          ...
          <button
            onClick={() => router.push('/master-sku')}
            className="w-full text-xs text-teal-700 border border-teal-200 py-2 rounded-lg hover:bg-teal-50 transition-colors"
          >
